...
| Param | Type | Description |
| --- | --- | --- |
| url | <code>string</code> | The URL to fetch GeoJSON or FGB data from. |
...
| Param | Type | Description |
| --- | --- | --- |
| sourceId | <code>string</code> | Identifier of the source to remove. |
...
| [position] | <code>string</code> | <code>&quot;&#x27;top-right&#x27;&quot;</code> | Position to add the control on the map.n] - Position to place the export control (e.g., 'top-right'). |
...
## addPopup(coord, text, popupStyle) → <code>Object</code>
Adds a popup to the map.
