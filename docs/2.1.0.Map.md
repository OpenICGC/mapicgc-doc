    ...
    <script>
      async function initMap() {
        ...
        const map = new mapicgcgl.Map({
          container: "map",
          style: data.Styles.TOPO, // or --> data.Styles.RASTER.TOPO,
...
| id          | Mostra                                                                                                               |
|-------------|---------------------------------------------------------------------------------------------------------------------|
| TOPO        | <img src="https://icgc-web-pro.s3.eu-central-1.amazonaws.com/produccio/s3fs-public/2024-10/mapabase_topo.jpg" width="250"> |
| ADMIN       | <img src="https://icgc-web-pro.s3.eu-central-1.amazonaws.com/produccio/s3fs-public/2024-10/mapabase_administratiu.jpg" width="250"> |
| LIGHT       | <img src="https://icgc-web-pro.s3.eu-central-1.amazonaws.com/produccio/s3fs-public/2024-10/mapabase_topo_gris.jpg" width="250"> |
| STANDARD    | <img src="https://icgc-web-pro.s3.eu-central-1.amazonaws.com/produccio/s3fs-public/2024-10/mapabase_estandard_0.jpg" width="250"> |
| SIMPLIFIED  | <img src="https://icgc-web-pro.s3.eu-central-1.amazonaws.com/produccio/s3fs-public/2024-10/mapabase_simplificat.jpg" width="250"> |
| ORTO        | <img src="https://icgc-web-pro.s3.eu-central-1.amazonaws.com/produccio/s3fs-public/2024-10/mapabase_orto.jpg" width="250"> |
| ORTOGREY    | <img src="https://icgc-web-pro.s3.eu-central-1.amazonaws.com/produccio/s3fs-public/2024-10/mapabase_orto_gris.jpg" width="250"> |
| ORTOHYBRID  | <img src="https://icgc-web-pro.s3.eu-central-1.amazonaws.com/produccio/s3fs-public/2024-10/mapabase_orto_hibida.jpg" width="250"> |
