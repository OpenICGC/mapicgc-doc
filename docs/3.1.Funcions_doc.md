...
<dl>
<dt><a href="#addGeocoderICGC">addGeocoderICGC()</a> → <code>Object</code></dt>
<dd><p>Add geocoder.</p>
</dd>
...
<dt><a href="#addFeatureQuery">addFeatureQuery(layerName, options)</a></dt>
...
## addPopup(options, coord, text) → <code>Object</code>
Adds a popup to the map.
